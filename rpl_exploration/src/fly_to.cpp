    ...
    public:
                   ...
                   actionlib::SimpleActionServer<rpl_exploration::FlyToAction> * as)
      {
        ...
        do
        {
          ...
          listener.waitForTransform("/mavros/world", "/red/base_link", ros::Time(0), ros::Duration(10.0) );
          listener.lookupTransform("/mavros/world", "/red/base_link", ros::Time(0), transform);
