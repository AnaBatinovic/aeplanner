...
int main(int argc, char** argv)
{
  ...
  geometry_msgs::PoseStamped::ConstPtr init_pose =
      ros::topic::waitForMessage<geometry_msgs::PoseStamped>("/red/mavros/"
                                                             "local_position/pose");
  ...
  for (int i = 0; i < 2; ++i)
  {
    ...
    goals.header.frame_id = "mavros/world";
  ...
  while (ros::ok())
  {
    ...
    aep_goal.header.frame_id = "mavros/world";
    ...
    else
    {
      ...
      rrt_goal.start.header.frame_id = "mavros/world";
